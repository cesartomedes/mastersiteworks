    ...
    <section id="services" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          <h2 className="text-4xl font-bold text-[#314528] mb-6">About Master Site Works</h2>
          <p className="text-gray-700 text-lg leading-relaxed">
            Master Site Works, Inc. is a licensed, bonded, and fully insured general contractor 
            specializing in site development and road construction. Areas of specialty include 
            grading, storm drainage, erosion control, curb & gutter, stone bases, asphalt paving, 
            concrete construction, pavement markings, and incidentals to land development, road 
            construction, and pavement maintenance.
          </p>
        </div>

        {/* TÍTULO SERVICIOS */}
        <h3 className="text-3xl font-bold text-center text-[#314528] mb-12">Our Services</h3>
